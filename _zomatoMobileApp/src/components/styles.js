...
export default StylesJS = StyleSheet.create({
    ...
    default: { fontSize: 12, alignSelf: 'center'},
    priceBold: {fontSize: 16, fontWeight:'bold', alignSelf: 'center'},
    customListView: { alignItems: 'center', flexDirection: 'row', flex: 1, justifyContent:'space-evenly', color: '#0b1d1c'},
